...
public class ListenerFactory {
    ...
    private Map<Class, OnClickListener> mViewOnClickListenerMap;
    ...
    public ListenerFactory(Map<Class, OnItemViewClickedListener> onItemViewClickedListenerMap,
            ...
            Map<Class, OnClickListener> viewOnClickListenerMap) {
    ...
    public OnClickListener getViewOnClickListener(Class key) {
